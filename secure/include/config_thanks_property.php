...
// 送信先メールアドレス ※
$mail_to = "info_project@lectio.co.jp";
//$mail_to = "sahara@orange-d.jp";

// 複数の時用
// $mail_to .= "aa@aa.ne.jp\r\n"; //送信先メールアドレス

$mail_subject = "【LECTIO DESIGN】『物件紹介フォーム』よりお問い合わせがありました"; //メールの件名
$mail_body    = $honbun; //メールの本文

// 送信元表示メールアドレス（お客様側も共通）※
$mail_moto    = "info_project@lectio.co.jp\r\n";
//$mail_moto    = "sahara@orange-d.jp\r\n";
