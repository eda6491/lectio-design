...
if (!$_SESSION["PERSON_INFO"]) {
  ...
  echo '<p style="text-align: center; font-size: 24px; margin-top: 50px; color: red;">Invalid access!</p>';
  exit;
}
...
// Bcc ※
$mail_header .= "Bcc: takamori@bitwin.ne.jp,sasaki@bitwin.ne.jp,fujimoto@orange-d.jp\r\n"; //Cc送信先メールアドレス
...
$honbun2 .= "─────────────────────────\n\n";
$honbun2 .= "Thank you very much for inquiring of 'LECTIO DESIGN'.\n";
$honbun2 .= "I'll contact you later on than the person in charge.\n";
$honbun2 .= "Please soon wait a moment.\n\n";
$honbun2 .= "─────────────────────────\n";
$honbun2 .= "Contents of inquiry\n";
$honbun2 .= "─────────────────────────\n\n";
$honbun2 .= "Name：" . $namae . "\n\n";
$honbun2 .= "Company：" . $cname . "\n\n";
$honbun2 .= "E-mail：" . $mailaddress . "\n\n";
$honbun2 .= "Phone：" . $tel . "\n\n";
$honbun2 .= "Address：" . $address . "\n\n";
$honbun2 .= "Inquiry：" . $naiyou . "\n\n";
// $honbun2 .= "都道府県：".$prefectures."\n\n";
$honbun2 .= "─────────────────────────\n\n";
$honbun2 .= "■　LECTIO DESIGN　■\n\n";
$honbun2 .= "─────────────────────────\n\n";
$honbun2 .= "Lectio Design Co., Ltd.\n";
$honbun2 .= "Dai7 Akiyama Bld.3F,5-3,kojimachi,Chiyoda-ku,Tokyo,102-0083,Japan\n";
$honbun2 .= "TEL：+81-3-6272-5475（Reception time：Weekday 9:00am～5:00pm）\n";
$honbun2 .= "FAX：+81-3-6272-5476（Reception time：Weekday 9:00am～5:00pm）\n";
...
$mail_subject2  = "【LECTIO DESIGN】Thank you very much for inquiring"; //メールの件名 ※
